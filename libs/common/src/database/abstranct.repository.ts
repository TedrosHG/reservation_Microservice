...
import { AbstranctDocument } from "./abstract.schema";
import { Logger, NotFoundException} from '@nestjs/common';


export abstract class AbstractRepository<TDocument extends AbstranctDocument> {
    ...
    async findOne(filterQuery: FilterQuery<TDocument>): Promise<TDocument>{
        ...
        console.log("the findone" , document);
